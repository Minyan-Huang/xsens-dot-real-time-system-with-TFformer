...
win.minsize(width = 1400, height = 800)
...
# video_label.place(x=100, y=100, width=640, height=480)
video_label.pack(side=tk.RIGHT, padx=10, pady=10, fill=tk.BOTH, expand=True)
...
btn_stop.place(x=50, y=750)  # Adjust the x and y values as needed
...
btn_con.place(x=400, y=750)  # Adjust the x and y values as needed
